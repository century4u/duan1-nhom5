...
match ($action) {
    ...
    'hvd/logs/store' => (new HvdController)->logStore(),
    'hvd/logs/update' => (new HvdController)->logUpdate(),
    'hvd/logs/delete' => (new HvdController)->logDelete(),

    // HDV Attendance
    'hvd/attendance' => (new HvdController)->attendance(),
    'hvd/attendance/store' => (new HvdController)->attendanceStore(),
